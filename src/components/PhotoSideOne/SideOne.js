        ...
        <nav className="sideone-sidebar-nav">
          ...
          <section className="sideone-link-cats">
            ...
            <ul className={weddingsClass}>
              <li className="category__item category__item-one">Bill & Frank, 2023</li>
              <li className="category__item category__item-two">Harry & Megan, 2018</li>
              <li className="category__item category__item-three">Jim & Pam, 2014</li>
              <li className="category__item category__item-four">Ross & Rachel, 2002</li>
              <li className="category__item category__item-five">Denise & Dwight, 2000</li>
            </ul><br /><br />

            <span onClick = {controlEngagements } className="sideone-link-cats__cat">ENGAGEMENTS + </span><br />
            <ul className={engagementsClass}>
              <li className="category__item category__item-one">Liz and Criss</li>
              <li className="category__item category__item-two">Emily and John</li>
              <li className="category__item category__item-three">Bill and Ted</li>
              <li className="category__item category__item-four">Christina and Everett</li>
            </ul><br />

            <span onClick={controlGraduations} className="sideone-link-cats__cat">GRADUATION + </span><br />
            <ul className={graduationsClass}>
              <li className="category__item category__item-one">Jiliian, Texas A&M</li>
              <li className="category__item category__item-two">Christopher UT Austin</li>
              <li className="category__item category__item-three">Tyler SHSU</li>
              <li className="category__item category__item-four">Robyn Texas State</li>
            </ul><br />

            <span onClick={controlNatures} className="sideone-link-cats__cat">NATURE + </span><br />
            <ul className={naturesClass}>
              <li className="category__item category__item-one">Houston Zoo</li>
              <li className="category__item category__item-two">Dallas Zoo</li>
              <li className="category__item category__item-three">African Safari</li>
              <li className="category__item category__item-four">Rio Grande Valley</li>
            </ul><br />

            <span onClick={controlCreatives} className="sideone-link-cats__cat">CREATIVE + </span><br />
            <ul className={creativesClass}>
              <li className="category__item category__item-one">Nightlife</li>
              <li className="category__item category__item-two">Stars</li>
              <li className="category__item category__item-three">Artistic</li>
              <li className="category__item category__item-four">Landscapes</li>
            </ul><br />

            <span onClick={controlJournals} className="sideone-link-cats__cat">JOURNAL + </span><br />
            <ul className={journalsClass}>
              <li className="category__item category__item-one">Apr, 2023</li>
              <li className="category__item category__item-two">Nov, 2022</li>
              <li className="category__item category__item-three">Feb, 2022</li>
              <li className="category__item category__item-four">Dec, 2021</li>
              <li className="category__item category__item-five">Aug, 2021</li>
              <li className="category__item category__item-six">Jan, 2021</li>
              <li className="category__item category__item-seven">Sept, 2020</li>
              <li className="category__item category__item-eight">Mar, 2020</li>
            </ul><br />
